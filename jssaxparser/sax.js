...
export class SAXParser {
    ...
    */
    ...
    static getPatternFromChildren(model, xmlFilter) {
        ...
        if (brackets != null) {
            let restOfModel = brackets[1];
            let operator = brackets[2];
            let pattern = SAXParser.getPatternFromChildren(restOfModel, xmlFilter);
            switch (operator) {
                case "?":
            ...
            let operator = parsedModel[2];
            let separator = parsedModel[4];
            let restOfModel = parsedModel[5];
            ...
            if (restOfModel) {
                pattern2 = SAXParser.getPatternFromChildren(restOfModel, xmlFilter);
            }
            if (pattern2) {
                if (separator === "|") {
