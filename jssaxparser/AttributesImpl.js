 ...
 */
class AttributesImplBase {
    _getIndexByQName(qName) {
...
export class AttributesImpl extends AttributesImplBase {
    constructor(atts) {
        super();
        this.attsArray = [];
        if (atts) {
    ...
    getIndex(arg1, arg2) {
        if (arg2 === undefined) {
            return this._getIndexByQName.call(this, arg1);
        } else {
            return this._getIndexByURI.call(this, arg1, arg2);
        }
    }
    ...
    getType(arg1, arg2) { // Should allow 1-2 arguments of different types: idnex or qName or uri+localName
        ...
        if (!arg2) {
            if (arg1) {
                ...
                if (!index && index !== 0) {
                    //then it is qName
                    index = this._getIndexByQName.call(this, arg1);
                }
            }
        } else {
            index = this._getIndexByURI.call(this, arg1, arg2);
        }
        if (index || index === 0) {
    ...
    getValue(arg1, arg2) {
        if (arg2 === undefined) {
            if (typeof arg1 === "string") {
                return this._getValueByQName.call(this, arg1);
            } else {
                return this._getValueByIndex.call(this, arg1);
            }
        } else {
            return this._getValueByURI.call(this, arg1, arg2);
        }
    }

    // Other AttributesImpl methods
    addAttribute(uri, localName, qName, type, value) {
        let prefix = this._getPrefix.call(this, localName, qName);
...
export class Attributes2Impl extends AttributesImpl {
    constructor(atts) {
        super(atts);
        if (atts) {
    ...
    isDeclared(indexOrQNameOrURI, localName) {
        let index = this._getIndex(indexOrQNameOrURI, localName);
